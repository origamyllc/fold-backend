 ...
 */
export const failed_to_get_collections =  { details: { message : "failed to get collections",status:3200 }};
export const failed_to_insert =  { details: { message : "failed to insert document",status:3201 }};
